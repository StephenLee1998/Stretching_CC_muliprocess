...
yearrange = [2015 2017]; % year of the data
dayrange = [0 365]; % range of days in a year for CF calculation
...
outCFdir = '../NCFs/Standard/'; % output folder for CFs
...
if IndexParfor==1 % use parallel computing
    ...
    parfor k=1:NumStaPair
        noisecorr_sac_parfor(k,i_j_sta(k,:),parameter_file_tmp);
    end
