...
%indir = '/work/li_chao/work/Axial_Seamount/Noise_Axial_Seamount/AXEC2_AXID1/Z-Z/ascii';
indir = '/work/li_chao/work/Axial_Seamount/Noise_Axial_Seamount/Distant_Station/Z-Z/ascii/'
%indir = '/work/li_chao/work/Axial_Seamount/Noise_Axial_Seamount/AXEC2_AXBA1_CODA/Z-Z/ascii'
%indir = '/work/li_chao/work/Axial_Seamount/Noise_Axial_Seamount/AXCC1_AXBA1_CODA_STEADY/Z-Z/ascii'
%indir = '/work/li_chao/work/Axial_Seamount/Noise_Axial_Seamount/AXCC1H_AXCC1H/Z-Z/ascii'
% indir = 'corofgn';
% indir = 'CFs';
% outdir = 'cor';
% if(~exist(outdir,'dir'))
