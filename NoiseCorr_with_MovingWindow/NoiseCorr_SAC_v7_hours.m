...
StaFile = 'sta_AXCC1_AXCC1H.txt';   % file containing the station information
...
dailyrange = [78 365]; % range of days in a year for CF calculation
%dailyrange = [114 164]
dayeruption = 0 ;
...
outCFdir = './AXCC1H_AXCC1H/'; % output folder for CFs
...
for day = dailyrange(1):dailyrange(2)
    ...
    if IndexParfor==1 % use parallel computing
        ...
        parfor k=1:NumStaPair
            noisecorr_sac_parfor_hours(k,i_j_sta(k,:),parameter_file_tmp);
        end
